...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
  ...
  <input type="text" placeholder="Enter your phone number" name="mobile" value="<?php echo $mobile;?>">
        </div>
    </div>
  ...
  <input type="radio" name="gender" <?php if (isset($gender) && $gender=="female") echo "checked";?> value="female" style="color:white;"> <span style="color:white;"> Female</span>
  <input type="radio" name="gender" <?php if (isset($gender) && $gender=="male") echo "checked";?> value="male" style="color:white;">
  ...
  <textarea name="comment" placeholder="Comments" class="form-control" rows="5"><?php echo $comment;?></textarea>
    </div>        
    </div>
